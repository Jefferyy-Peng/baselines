...
loss_mode = 'Focal'
image_size = 256
VERSION = f'{MODEL_NAME.value}_{loss_mode}_0.97_Unified_equal_rate_batch_{batch_size}_tumorsplit_0.001_image_{str(image_size)}_dataset_{dataset}'
...
if dataset == 'picai':
  PATH_DIR = './dataset/lesion_segdata_combined/data_3d' if MODEL_NAME == ModelName.swin_unetr or MODEL_NAME == ModelName.masam else './dataset/lesion_segdata_combined/data_2d'
