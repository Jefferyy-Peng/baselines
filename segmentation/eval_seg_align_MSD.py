...
from segmentation.MedSAMAuto import MedSAMAUTOMULTIALIGNTYPE1, TextEncoder
...
if __name__ == '__main__':
    ...
    if use_pseudo_text:
        net = MedSAMAUTOMULTIALIGNTYPE1PSEUDO(
    ...
    ## Seg + Align
    ckpt_path = '/segmentation/new_ckpt/seg/Seg_Align/2024-11-08T18:12:39_lr_0.0001_weight_decay_0.001/fold1/epoch:1-gland_val_dice:0.90660-zone_val_dice:0.86871-lesion_val_dice:0.93265-lesion_val_ap:0.76725-lesion_val_auc:0.96746.pth'
    # ckpt_path = '/usa/mengma/myproject/cvpr25/baselines/segmentation/new_ckpt/seg/Seg_Align/2024-11-12T08:12:43_lr_0.0001_weight_decay_0.001/fold1/epoch:5-gland_val_dice:0.90245-zone_val_dice:0.86271-lesion_val_dice:0.93947-lesion_val_ap:0.78250-lesion_val_auc:0.98602.pth'
