...
if __name__ == "__main__":
    phase = 'seg'
    base_dir = '../output_lesion_MSD/nnUNet_raw_data/Task2201_picai_baseline/imagesTr'
    label_dir = '../output_lesion_MSD/nnUNet_raw_data/Task2201_picai_baseline/labelsTr'
