...
def main(taskname="Task2201_picai_baseline"):
    ...
    parser.add_argument('--outputdir', type=str, default=os.environ.get('SM_MODEL_DIR', "../output_gland_AI_test"))
    ...
    annotations_dir = labels_dir / "anatomical_delineations/whole_gland/AI/Bosma22b"
